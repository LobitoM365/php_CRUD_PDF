...
<body>
    ...
    <div class="grid grid-cols-1 grid-rows-[auto,1fr] h-screen">
        <nav class="bg-white dark:bg-gray-900 h-max w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="{{ asset('img/logoRick.png') }}" class="h-8" alt="Flowbite Logo">
